  ...
  return (
      ...
      <section className="relative overflow-hidden bg-blue-950 dark:bg-slate-950 py-10 lg:py-14">
        <img 
          ...
          srcSet="
            https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=640&auto=format&fit=crop 640w,
            https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=1024&auto=format&fit=crop 1024w,
            https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?q=80&w=1920&auto=format&fit=crop 1920w
          "
          sizes="100vw"
          alt=""
          fetchPriority="high"
          loading="eager"
          className="absolute inset-0 w-full h-full object-cover object-center opacity-10 mix-blend-overlay"
        />
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-4 justify-center items-stretch pt-10">
                {radioPlansData.map((plan: any) => (
                  <div
                    key={plan.id}
                    className={`relative flex flex-col h-full bg-white dark:bg-slate-900 rounded-2xl p-5 md:p-6 border transition-all duration-300 group hover:-translate-y-2 hover:shadow-xl hover:border-amber-500/50 ${
                      plan.isPopular 
