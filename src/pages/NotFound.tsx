...
export default function NotFound() {
 ...
 <AlertCircle className="w-32 h-32 text-blue-600 relative z-10" />
 </div>
 </div>
 
 <div className="space-y-3">
 <h1 className="text-7xl font-black text-slate-900 font-display tracking-tighter">
 404
 </h1>
 ...
 className="w-full sm:w-auto px-6 py-3 rounded-full border-2 border-slate-200 font-bold text-slate-700 hover:bg-slate-100 transition-all flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-500"
 >
