...
"isPartOf": {"@id": company.schemaIds.website }
 ...
 <section className="relative overflow-hidden bg-slate-900 py-10 lg:py-14">
  ...
  alt="Link Dedicado Intertel para Empresas"
  fetchPriority="high"
  loading="eager"
 ...
 <h2 className="text-3xl font-black text-slate-900 font-display mb-4">Por que escolher o Trânsito IP Intertel?</h2>
 <p className="text-slate-600 text-lg">Nossa infraestrutura foi desenhada para não falhar. Conheça os diferenciais que garantem a entrega máxima para os seus clientes finais.</p>
 </div>
