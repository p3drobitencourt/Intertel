          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-12 border-b border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-6">
              <Link to="/" className="inline-block" aria-label="Home">
                <img src="/logo-principal.png" alt="Intertel Telecom" loading="lazy" className="h-20 md:h-24 w-auto object-contain mix-blend-multiply dark:mix-blend-normal dark:bg-slate-900 dark:p-2 dark:rounded-xl" />
              </Link>
              ...
              <div className="flex gap-4 pt-2">
                ...
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-slate-800 hover:bg-slate-700 flex items-center justify-center text-slate-400 hover:text-white transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-amber-500"
                >
                  <Instagram className="w-5 h-5" />
                </a>  <a href="https://api.whatsapp.com/send/?phone=5535999042885&text&type=phone_number&app_absent=0" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-[#25D366] hover:text-white dark:hover:bg-[#25D366] text-slate-600 dark:text-slate-300 flex items-center justify-center transition-all shadow-sm">
