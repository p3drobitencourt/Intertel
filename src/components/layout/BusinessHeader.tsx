  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 border-b border-slate-200 dark:border-slate-800 ${isScrolled ? 'bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg shadow-md py-2' : 'bg-white/90 dark:bg-slate-900/90 backdrop-blur-md shadow-sm'}`}>
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 h-20 md:h-24 flex items-center justify-between">
        ...
        {/* Logo */}
        <Link to="/empresas" className="flex items-center justify-start bg-transparent focus:outline-none shrink-0 h-14 md:h-16 w-36 md:w-48 relative overflow-hidden dark:bg-slate-900/50 dark:rounded-xl" id="nav-logo-business">
          <img src="/logo-principal.png" alt="Intertel Telecom B2B" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[220%] max-w-none h-auto object-contain mix-blend-multiply dark:mix-blend-normal" />
        </Link>
