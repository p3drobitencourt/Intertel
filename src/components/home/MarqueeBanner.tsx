...
export default function MarqueeBanner() {
  return (
    <div className="relative w-full bg-[#F4B000] border-b border-amber-500 py-3 z-30 overflow-hidden flex items-center shadow-md">
      <div className="flex whitespace-nowrap motion-safe:animate-marquee items-center text-slate-950 font-black tracking-[0.2em] uppercase text-[10px] sm:text-[11px]">
