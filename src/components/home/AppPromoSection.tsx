          ...
          <div className="relative w-full py-8 lg:py-0 flex items-center justify-center mt-12 lg:mt-0">
            ...
            <div className="relative w-full max-w-[260px] sm:max-w-[320px] lg:max-w-[360px] mx-auto">
              ...
              <div className="relative w-full z-20 transition-transform duration-500 hover:-translate-y-4">
                ...
                <div className="relative bg-slate-900 rounded-[2.5rem] sm:rounded-[3rem] p-1.5 sm:p-2 shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_25px_50px_rgba(0,0,0,0.6)]">
