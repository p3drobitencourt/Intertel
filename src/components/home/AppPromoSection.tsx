...
export default function AppPromoSection() {
 return (
 <section className="bg-slate-50 py-12 sm:py-16 relative z-10" id="app-promo">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
 {/* Left Column: Value Proposition */}
 <div className="space-y-6 max-w-xl">
 <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 text-blue-700 text-xs font-bold uppercase tracking-wider">
 ...
 Sua conex├úo na palma da m├úo. Com o app Intertel Telecom, voc├¬ tem total autonomia para gerenciar sua internet. Pague faturas com PIX, acompanhe seu consumo di├írio e utilize o recurso de promessa de pagamento para liberar sua conex├úo em um clique.
 </p>
 ...
 <span className="text-[8px] sm:text-[9px] uppercase tracking-wider leading-none text-slate-300">Dispon├¡vel no</span>
 <span className="text-xs sm:text-sm font-bold leading-tight">Google Play</span>
 </div>
 </a>
 <a href="https://apps.apple.com/br/app/intertel-telecom/id1618099722" target="_blank" rel="noopener noreferrer" id="CTA_APP_STORE_PROMO" data-tracking="CTA_APP_STORE" className="flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg bg-slate-900 text-white hover:bg-slate-800 transition-colors shrink-0">
 <svg viewBox="0 0 24 24" className="w-5 h-5 sm:w-6 sm:h-6 fill-current" xmlns="http://www.w3.org/2000/svg">
 ...
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-md max-h-[400px] bg-blue-500/10 rounded-full blur-3xl -z-10"></div>

 <div className="relative w-full max-w-[260px] sm:max-w-[320px] lg:max-w-[360px] mx-auto">
 
 {/* Celular Único: Frente (Dashboard) */}
 <div className="relative w-full z-20 transition-transform duration-500 hover:-translate-y-4">
 {/* Corpo do Celular (Borda e Fundo) */}
